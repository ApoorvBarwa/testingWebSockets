                            ...
                            <div class="dashboard-stat2 " id="introJsDashboard_1">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>Pending SCC Approval</small>
                                    </div>
                                    <div class="icon">
                                ...
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-red-haze">
                                            <span data-counter="counterup" id="pendingOPSClarification"></span>
                                        </h3>
                                        <small>Pending Clarification from OPS</small>
                                    </div>
                                    <div class="icon">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="dashboard-stat2 " id="introJsDashboard_4">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-blue-sharp">
                                            <span data-counter="counterup" id="historicRequests"></span>
                                        </h3>
                                        <small>Historic Requests</small>
                                    </div>
                                    <div class="icon">
                                        <i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
                                    </div>
